...
export class NetworkController {
    ...
    async createNetwork(
        ...
        return this.networkService.createNetwork(req.user.id, connectionUuid, networkConfig);
    }
    ...
    async connectContainer(
        ...
        return this.networkService.connectContainer(req.user.id, connectionUuid, uuid, containerId, config);
    }
    ...
    @ApiResponse({
        status: 200,
        description: 'The container has been successfully disconnected from the network',
    })
    async disconnectContainer(
        ...
        return this.networkService.disconnectContainer(req.user.id, connectionUuid, uuid, containerId, force);
    }
