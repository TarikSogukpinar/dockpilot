import { Controller, Get, Req, Post, Body, Param, Query, Delete, UseGuards, ParseUUIDPipe } from '@nestjs/common';
...
export class VolumeController {
    ...
    async createVolume(
        ...
        return this.volumeService.createVolume(req.user.id, connectionUuid, volumeConfig);
    }
    ...
    async removeVolume(
        ...
        return this.volumeService.removeVolume(req.user.id, connectionUuid, uuid, force);
    }
    ...
    async createBackup(
        ...
        return this.volumeService.createBackup(req.user.id, connectionUuid, uuid, backupConfig);
    }
    ...
    async createSnapshot(
        ...
        return this.volumeService.createSnapshot(req.user.id, connectionUuid, uuid, snapshotConfig);
    }
}
